...
public class Operator {
	public static void main(String[] args) {
		...
		// int10의 값이 없으므로 위 수식은 오류!!

		int int11 = 10, int12 = 20, int13;
		...
		// System.out.printf("0 % 7 = %fn", int34);
		...
		byte16 += float11; // byte 16 = byte16 + float11
		...
		bool5 = (int53 == int54);
		bool5 = (int53 == int54 && int54 == int55);
		// 컴파일 오류! 수식을 분리해야 함
		// int53 == int54 && int54 == int55
		// 90<= avg <= 100 (x) - 수식 분리
		// avg >= 90, avg <= 100
		System.out.printf("결과값은? = %s \n", bool5);
		bool5 = (int53 == (int54 + 1));
		System.out.printf("%s \n", bool5);
		...
		int int71 = 10;
		int int74 = 15;
		boolean bool18 = (int71 > 5 && int74 > 10);
		boolean bool19 = (int71 > 20 && int74 > 10);
		// 단축평가 실행, 좌변식이 거짓 - 전체 거짓
		boolean bool20 = ((int71 = 50) > 5);

		boolean bool21 = (int71 > 5 || int74 > 10);
		// 단축평가 실행, 좌변식이 참 - 전체 참
		boolean bool22 = (int71 > 20 || int74 > 10);
