...
class ColorBox extends Box {
	// 부모 클래스의 생성자를 암시적으로 호출
	public ColorBox() {
		System.out.println("ColorBox 클래스의 생성자");
	}
}

class NewColorBox extends ColorBox {
	public NewColorBox() {
		System.out.println("NewColorBox 클래스의 생성자");
	}
}
